...
@Path("ndd/search")
public class DataDictionarySearchService extends AbstractWdkService {
    private static final Logger LOG = Logger.getLogger(DataDictionarySearchService.class);
    ...
    + "matches AS (" + NL
    + "SELECT * FROM data_dict_text_search((SELECT term FROM st))" + NL
