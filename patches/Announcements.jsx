      ...
      if (true /*isGenomicHomePage(props.projectId, props.location)*/) {
        return (
          <div key="live-beta">
            ...
            <span style={{color:"red"}}><h5>We are currently experiencing technical difficulties.  Variant record pages and some REST API calls are currently unavailable.  We are working to resolve this as soon as possible.  Our apologies for the inconvience.</h5></span>
          </div>
        );
      }
    },
