...
const HomePage: React.SFC<HomePage> = props => {
	...
	return <div className='home-page2'>
		<div className="row section-1" style={
			{
			...
			<div className="section col-sm-12 pt-5 pb-5">
				...
				<div className="col-sm-12 quick-search-container-main">
					<div className="quick-search-container-main">
						<QuickSearchMulti webappUrl={webAppUrl} showTooltip={false} />
						<div className='search-examples'>
							<p>
								Examples -
								Gene: <Link to={'record/gene/ENSG00000130203'}> APOE</Link> -
								Variant by RefSNP: <Link to='record/variant/rs6656401'>rs6656401</Link> -
								Variant: <Link to='record/variant/19:45411941:T:C_rs429358'>19:45411941:T:C</Link>
							</p>
						</div>
					</div>
				</div>
		...
		<div className="row section-2">
			<div className="section col-sm-12">
				...
				<div className='feature-items row'>
					{
						_featureConfig.map(config => <FeatureItem key={config.title} className='col-md-4 ' config={config} />)
					}
				</div>
			</div>
		</div>
