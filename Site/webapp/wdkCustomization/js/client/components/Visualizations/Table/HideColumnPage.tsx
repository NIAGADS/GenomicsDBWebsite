import { Checkbox, FormControlLabel, Popover, Modal, Typography, createStyles, makeStyles } from '@material-ui/core'
...
export function HideColumnPage<T extends Record<string, unknown>>({
  instance,
  anchorEl,
  onClose,
  show,
