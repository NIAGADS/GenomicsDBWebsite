...
import { MultiSearch, SearchResult, SecondaryLink } from "../../components/Shared";
                        ...
                        <Grid item container spacing={2} direction="column">
                            ...
                            <Grid item>
                                <DarkContrastText>
                                    ...
                                    platform for data sharing, discovery, and analysis to help advance the understanding
                                    of the complex genetic underpinnings of AD neurodegeneration and accelerate the
                            ...
                            <Grid item>
                                <DarkContrastText variant="caption">
                                    Examples - Gene:{" "}
                                    <SecondaryLink to={"record/gene/ENSG00000130203"}> APOE</SecondaryLink> - Variant by
                                    RefSNP: <SecondaryLink to="record/variant/rs6656401">rs6656401</SecondaryLink> -
                                    Variant:{" "}
