        ...
        <WhiteBackgroundSection>
            <Grid container alignItems="center" item direction="column" spacing={6}>
                ...
                <Grid item container spacing={4} direction="row" alignContent="center">
                    ...
                    >
                        <BaseText>
                            Use our interactive genome browser to visually inspect NIAGADS GWAS summary statistics
                            datasets in their broader genomic context. Compare datasets to each other, against annotated
                            gene or variant tracks, and to functional genomics tracks from the NIAGADS{" "}
                            <PrimaryExternalLink href={_externalUrls.FILER_TRACK_URL}>FILER</PrimaryExternalLink>{" "}
                            functional genomics repository.
                        </BaseText>
                        <Box display="flex" justifyContent="flex-end">
                            <PrimaryActionButton href="/visualizations/browser?locus=ABCA7">
                                <span>
                                    Check it out{"    "}
                    ...
                    <Grid item xs={12} md={6}>
                        <img width="1000px" src={`${webAppUrl}/images/home/genome-browser.svg`} />
